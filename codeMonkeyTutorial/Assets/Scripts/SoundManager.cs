...
public class SoundManager : MonoBehaviour {
    ...
    private const string PLAYER_PREF_SFX_VOLUME = "SXFVolume";
    ...
    private void Start() {
        ...
        Player.Instance.OnPickedSoemthing += Player_OnPickedSomething;
    ...
    public void PlayFootstepSounds(Vector3 position, float volume) {
